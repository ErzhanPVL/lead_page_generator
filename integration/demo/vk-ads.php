...
foreach ($_POST['leads'][$lead_status] as $item) {
    ...
    if (!$ym_uid) {
        ...
        create_system_note($headers, $subdomain, $lead_id, 'MESSG', 'Ошибка отправки конверсии в VK ADS · отсутствует идентификатор клиента');
        ...
        create_system_note($headers, $subdomain, $lead_id, 'MESSG', 'Ошибка отправки конверсии в VK ADS · не указано название конверсии');
        
        continue;
        }
        
        $url = "https://top-fwz1.mail.ru/tracker?id=3264613;e=RG%3A0/$name;userid=$ym_uid";
        ...
        create_system_note($headers, $subdomain, $lead_id, 'MESSG', 'Конверсия «'. $name .'» отправлена в VK ADS');
    }    
}
